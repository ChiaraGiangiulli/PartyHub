...
<div class="container">
    ...
    <div class="col-8"><center><p class="p-1"><?php print_r($templateParams['evento'][0]['Nome'])?></p></center></div>
    <div class="col-2"></div>
</div>
</nav>
        ...
        <div class="col-8">
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    ...
                    <a href="#"><?php print_r($templateParams['evento'][0]['Organizzatore'])?></a></li>
                <li class="list-group-item">
...
<nav class="navbar navbar-expand bg-light justify-content-center">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == "/PartyHub/src/profilePost.php"){echo "active";}?>" href="/PartyHub/src/profilePost.php">Planning</a>
        </li>
        <li class="nav-item">
