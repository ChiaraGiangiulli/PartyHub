    ...
    <div class="row">
        ...
        <div class="col-8">
            <ul class="list-group list-group-flush">
                ...
                <?php print_r($templateParams['evento'][0]['Nome'])?></li>
                <li class="list-group-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                    </svg>
                    <a href="otherUsers.php?user=<?php print_r($templateParams['evento'][0]['Organizzatore'])?>"><?php print_r($templateParams['evento'][0]['Organizzatore'])?></a></li>
                <li class="list-group-item">
                ...
                <?php print_r($templateParams['evento'][0]['Data'])?></li>
                <li class="list-group-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
                        <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
                        <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                    </svg>
                <?php print_r($templateParams['evento'][0]['Citta'])?></li>
                <li class="list-group-item">
                    <button id="eventPartecipants" type="button" class="btn btn-outline-light text-dark" data-bs-toggle="modal" data-bs-target="#partecipantsModel">
                        ...
                        <?php print_r($templateParams['evento'][0]['NumeroPartecipanti'])?></li>
                    </button>
...
<?php if(count($dbh->isAccepted($_SESSION['userId'],$templateParams['evento'][0]['idEvento'])) > 0
    ...
    ?>    
                ...
                <?php print_r($templateParams['evento'][0]['Ora'])?></li>      
                <li class="list-group-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pin-map" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M3.1 11.2a.5.5 0 0 1 .4-.2H6a.5.5 0 0 1 0 1H3.75L1.5 15h13l-2.25-3H10a.5.5 0 0 1 0-1h2.5a.5.5 0 0 1 .4.2l3 4a.5.5 0 0 1-.4.8H.5a.5.5 0 0 1-.4-.8z"/>
                    <path fill-rule="evenodd" d="M8 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z"/>
                    </svg>
            <?php print_r($templateParams['evento'][0]['Indirizzo']); print_r(" "); print_r($templateParams['evento'][0]['NumeroCivico'])?></li>
            </ul>
        </div>
    </div>
</div>
