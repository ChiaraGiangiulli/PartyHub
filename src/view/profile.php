    ...
    <div class="col-sm-12 text-center mt-4 mb-4">
      <div id="profileForm" class="btn-group">
        ...
        <button id="followers" type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#followersModal">
          ...
          <button id="newEvent" type="button" class="btn btn-outline-success">
            ...
            </svg> New Event</button>
      </div>
    </div>
    <nav class="navbar navbar-expand bg-light justify-content-center">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php if(basename($_SERVER['PHP_SELF']) == "/PartyHub/src/views/profilePosts.php"){echo "active";}?>" href="/PartyHub/src/view/profilePost.php">Posts</a>
          </li>
          <li class="nav-item">
