        ...
        <table class="table table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <?php if($numeroVoti > 0){ ?>
                    <th class="price"><div class="progress"> 
                        <div class="progress-bar bg-success" role="progressbar" style="width:<?php print_r(($opzione['NumeroVoti']*100)/$numeroVoti)?>%" aria-valuenow="<?php print_r(($opzione['NumeroVoti']*100)/$numeroVoti)?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </th>
                    <?php }
                        else{ ?>
                    <th class="price">
